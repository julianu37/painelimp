     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-wrap sm:flex-nowrap justify-between items-center gap-2">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                <?php echo e(__('Gerenciar Modelos')); ?>
            ...
            <div class="flex items-center space-x-2">
                ...
                <form method="GET" action="<?php echo e(route('admin.modelos.index')); ?>" class="flex items-center space-x-1">
                    <select id="marca_id_filter" name="marca_id" onchange="this.form.submit()" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm text-sm py-1.5">
                        ...
                        <?php $__currentLoopData = $marcas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $nomeMarca): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($id); ?>" <?php echo e(request('marca_id') == $id ? 'selected' : ''); ?>><?php echo e($nomeMarca); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    <?php if(request('marca_id')): ?>
                        <a href="<?php echo e(route('admin.modelos.index')); ?>" class="text-xs text-red-500 hover:underline p-1" title="Limpar Filtro">&times;</a>
                    <?php endif; ?>
                </form>
            </div>
            
            <a href="<?php echo e(route('admin.modelos.create')); ?>" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 active:bg-indigo-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150 whitespace-nowrap">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg sm:rounded-lg">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $modelos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modelo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    <td class="px-6 py-4">
                                        <?php echo e($modelo->marca->nome ?? 'N/A'); ?>
                                    ...
                                    <td class="px-6 py-4 text-right space-x-2 whitespace-nowrap">
                                        ...
                                        <form action="<?php echo e(route('admin.modelos.destroy', $modelo)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Tem certeza que deseja excluir este modelo?');">
                                            <?php echo csrf_field(); ?>
                                ...
                                <tr class="bg-white dark:bg-gray-800">
                                    <td colspan="4" class="px-6 py-10 text-center text-gray-500 dark:text-gray-400">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <?php endif; ?>
                                            <a href="<?php echo e(route('admin.modelos.create', request()->only('marca_id'))); ?>" class="mt-2 text-sm text-indigo-600 dark:text-indigo-400 hover:underline">Adicionar o primeiro modelo</a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endif; ?>
                ...
                <?php if($modelos->hasPages()): ?>
                    <div class="p-4 bg-gray-50 dark:bg-gray-700/50 border-t dark:border-gray-700">
                         <?php echo e($modelos->appends(request()->query())->links()); ?>
...
<?php endif; ?> <?php /**PATH C:\painelimp\resources\views\admin\modelos\index.blade.php ENDPATH**/ ?>