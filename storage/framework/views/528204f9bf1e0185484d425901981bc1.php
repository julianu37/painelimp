    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm">
                <form action="<?php echo e(route('manuais.index')); ?>" method="GET" class="flex items-center space-x-3">
                    <input type="search"
                           name="busca_manual"
                           placeholder="Buscar por nome ou arquivo..."
                           value="<?php echo e(request('busca_manual')); ?>"
                    ...
                    <?php if(request('busca_manual')): ?>
                        <a href="<?php echo e(route('manuais.index')); ?>" class="text-sm text-gray-500 hover:text-gray-700 whitespace-nowrap">Limpar busca</a>
                    <?php endif; ?>
                </form>
            </div>
                                        ...
                                        <p class="text-sm text-gray-500 dark:text-gray-400" title="<?php echo e($manual->arquivo_nome_original); ?>">
                                         ...
                                         <?php if($manual->modelos->isNotEmpty()): ?>
                                             <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                                 Modelo(s): 
                                                 <?php $__currentLoopData = $manual->modelos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modelo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <a href="<?php echo e(route('modelos.show', $modelo)); ?>" class="hover:underline"><?php echo e($modelo->nome); ?></a><?php if($modelo->marca): ?>(<a href="<?php echo e(route('marcas.show', $modelo->marca)); ?>" class="hover:underline"><?php echo e($modelo->marca->nome); ?></a>)<?php endif; ?><?php echo e(!$loop->last ? ', ' : ''); ?>
