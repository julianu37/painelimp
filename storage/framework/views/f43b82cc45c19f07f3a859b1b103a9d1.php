...
<?php endif; ?>
            ...
            <?php if(Route::has('password.request')): ?>
                <a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800 mt-4" href="<?php echo e(route('password.request')); ?>">
         ...
         <?php if(Route::has('register')): ?>
            <div class="text-center mt-4">
                 <a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="<?php echo e(route('register')); ?>">
                    <?php echo e(__('Ainda não tem conta? Registre-se')); ?>
...
<?php endif; ?>
<?php /**PATH C:\painelimp\resources\views\auth\login.blade.php ENDPATH**/ ?>