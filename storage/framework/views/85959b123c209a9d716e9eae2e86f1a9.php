     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                <?php echo e(__('Gerenciar Marcas')); ?>

            </h2>
            <a href="<?php echo e(route('admin.marcas.create')); ?>" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 active:bg-indigo-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $marcas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $marca): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        ...
                                        <?php echo e($marca->modelos_count ?? 0); ?>

                                    </td>
                                    <td class="px-6 py-4">
                                        <?php echo e($marca->created_at->format('d/m/Y')); ?>

                                    </td>
                                    <td class="px-6 py-4 text-right space-x-2 whitespace-nowrap">
                                        
                                        <a href="<?php echo e(route('admin.marcas.edit', $marca)); ?>" class="inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded text-indigo-700 bg-indigo-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:bg-indigo-900/50 dark:text-indigo-300 dark:hover:bg-indigo-800/50 dark:focus:ring-offset-gray-800">
                                        ...
                                        <form action="<?php echo e(route('admin.marcas.destroy', $marca)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Tem certeza? Todos os modelos associados serão excluídos!');">
                                            <?php echo csrf_field(); ?>
                                ...
                                <tr class="bg-white dark:bg-gray-800">
                                    <td colspan="4" class="px-6 py-10 text-center text-gray-500 dark:text-gray-400">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <a href="<?php echo e(route('admin.marcas.create')); ?>" class="mt-2 text-sm text-indigo-600 dark:text-indigo-400 hover:underline">Criar a primeira marca</a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endif; ?>
...
<?php endif; ?> <?php /**PATH C:\painelimp\resources\views\admin\marcas\index.blade.php ENDPATH**/ ?>