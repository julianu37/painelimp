     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                <?php echo e(__('Gerenciar Códigos de Erro')); ?>

            </h2>
            <a href="<?php echo e(route('admin.codigos.create')); ?>" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 active:bg-indigo-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg sm:rounded-lg">
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $codigosErro; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $codigoErro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <?php echo e($codigoErro->codigo); ?>

                                    </th>
                                    <td class="px-6 py-4 max-w-sm truncate" title="<?php echo e($codigoErro->descricao); ?>">
                                        <?php echo e($codigoErro->descricao); ?>

                                    </td>
                                    <td class="px-6 py-4 text-center">
                                        <?php echo e($codigoErro->modelos_count ?? 0); ?>

                                    </td>
                                    
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php echo e($codigoErro->created_at->format('d/m/Y')); ?>

                                    </td>
                                    <td class="px-6 py-4 text-right space-x-2 whitespace-nowrap">
                                         
                                        <?php if($codigoErro->modelos->isNotEmpty()): ?>
                                            <?php $primeiroModelo = $codigoErro->modelos->first(); ?>
                                            <a href="<?php echo e(route('modelos.codigos.show', [$primeiroModelo, $codigoErro])); ?>" target="_blank" 
                                        ...
                                        <form action="<?php echo e(route('admin.codigos.destroy', $codigoErro)); ?>" method="POST" class="inline-block" onsubmit="return confirm('Tem certeza? Soluções associadas ficarão sem código.');">
                                            <?php echo csrf_field(); ?>
                                ...
                                <tr class="bg-white dark:bg-gray-800">
                                    <td colspan="5" class="px-6 py-10 text-center text-gray-500 dark:text-gray-400">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <a href="<?php echo e(route('admin.codigos.create')); ?>" class="mt-2 text-sm text-indigo-600 dark:text-indigo-400 hover:underline">Adicionar o primeiro código</a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endif; ?>
...
<?php endif; ?> <?php /**PATH C:\painelimp\resources\views/admin/codigos/index.blade.php ENDPATH**/ ?>