...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <?php echo e(__('Marca:')); ?> <?php echo e($marca->nome); ?>
            ...
            <ol role="list" class="flex items-center space-x-4 text-sm list-none">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-4 text-sm font-medium text-gray-700 dark:text-gray-200"><?php echo e($marca->nome); ?></span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="mt-6">
                 <a href="<?php echo e(route('marcas.index')); ?>" class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800">
...
<?php endif; ?>
<?php /**PATH C:\painelimp\resources\views/public/marcas/show.blade.php ENDPATH**/ ?>