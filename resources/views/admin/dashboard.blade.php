                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg rounded-lg p-5 border border-gray-200 dark:border-gray-700">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <dd class="text-3xl font-semibold text-gray-900 dark:text-gray-100">{{ $totalSolucoes }}</dd>
                        </div>
                    </div>
                     <div class="mt-4 text-sm">
                        <a href="{{ route('admin.solucoes.index') }}" class="font-medium text-purple-600 dark:text-purple-400 hover:underline">Gerenciar Soluções &rarr;</a>
                    </div>
                </div>
