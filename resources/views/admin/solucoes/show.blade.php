    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                {{ __('Detalhes da Solução') }}
            </h2>
             <a href="{{ route('admin.solucoes.edit', $solucao) }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 active:bg-indigo-900 focus:outline-none focus:border-indigo-900 focus:ring ring-indigo-300 disabled:opacity-25 transition ease-in-out duration-150">
                Editar Solução
            </a>
        </div>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        {{-- <a href="{{ route('admin.imagens.create', ['attachable_type' => App\Models\Solucao::class, 'attachable_id' => $solucao->id]) }}" class="text-sm text-blue-600 hover:underline">Adicionar Imagem</a> --}}
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                     <div class="flex justify-between items-center mb-4">
                        <h3 class="text-lg font-medium">Vídeos Associados</h3>
                         {{-- <a href="{{ route('admin.videos.create', ['attachable_type' => App\Models\Solucao::class, 'attachable_id' => $solucao->id]) }}" class="text-sm text-blue-600 hover:underline">Adicionar Vídeo</a> --}}
                          <span class="text-xs text-gray-500">(Funcionalidade Adicionar Pendente)</span>
                    </div>
