    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
             ...
             {{-- TODO: Adicionar filtro por Código de Erro no header --}}
                            ...
                            @forelse ($solucoes as $solucao)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <td class="px-6 py-4 text-right space-x-2 whitespace-nowrap">
                                        ...
                                        {{-- Botão Excluir --}}
                                        <form action="{{ route('admin.solucoes.destroy', $solucao) }}" method="POST" class="inline-block" onsubmit="return confirm('Tem certeza? Imagens e vídeos associados NÃO serão excluídos automaticamente.');">
                                            @csrf
                                            @method('DELETE')
                                ...
                                <tr class="bg-white dark:bg-gray-800">
                                    <td colspan="4" class="px-6 py-10 text-center text-gray-500 dark:text-gray-400">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <a href="{{ route('admin.solucoes.create') }}" class="mt-2 text-sm text-indigo-600 dark:text-indigo-400 hover:underline">Adicionar a primeira solução</a>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
