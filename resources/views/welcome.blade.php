    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 text-center">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <a href="{{ route('codigos.index') }}" class="block p-6 bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-lg transition duration-300 ease-in-out transform hover:-translate-y-1">
                    <div class="flex items-center mb-3">
                        {{-- Ícone SVG - Exemplo: Alerta --}}
                ...
                <a href="{{ route('manuais.index') }}" class="block p-6 bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-lg transition duration-300 ease-in-out transform hover:-translate-y-1">
                 ...
                 {{-- Card Marcas/Modelos --}}
                 <a href="{{ route('marcas.index') }}" class="block p-6 bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-lg transition duration-300 ease-in-out transform hover:-translate-y-1 sm:col-span-2 lg:col-span-1"> {{-- Ajuste de coluna --}}
                     <div class="flex items-center mb-3">
